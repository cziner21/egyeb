		...
		<div id="content" class="brr">
            ...
            <div id="contentLeft">
                <div id="menuLeft">
					<ul>
                       ...
                       <li class="active"><?php echo anchor('vezerloPult/anyagok','Anyagok<span>Itt lehet az anyagokat felvenni és módosítani.</span>');?></li>
            ...
            <div id="contentRight">
                ...
                <div class="rightBlock">
                    ...
                    <div id="anyagokListazAjax" class="ajaxContainer">
        		      <div class="rightBlock">
        			     <div class="title">
        				    Anyagok
        				    <div class="controls">
                                ...
                                <table class="other">
					               <tbody>
						              ...
						              <td class="uid"><a href="#" class="sort ASC" rel="hozzaferes|uid|ASC">MID</a></td>
    						              ...
    						              <td><a href="#" class="sort " rel="hozzaferes|fullname|">Ár</a></td>
    						              <td><a href="#" class="sort " rel="hozzaferes|enabled|">Fajsúly</a></td>
