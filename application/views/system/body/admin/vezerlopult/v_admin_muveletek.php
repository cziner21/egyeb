	<div id="contentFrame">
		<div id="content" class="brr">
            ...
            <div id="contentLeft">
                <div id="menuLeft">
					...
					<ul>
                       ...
                       <li class="active"><?php echo anchor('vezerloPult/muveletek','Műveletekhez tartozó személyi költségek<span>Itt lehet a műveleteket felvenni és módosítani.</span>');?></li>
            ...
            <div id="contentRight">
                ...
                <div id="muveletekListazAjax" class="ajaxContainer">
    	            <div class="rightBlock">
    			    <div class="title">
    				    Műveletek
        				<div class="controls">
				    ...
				    <form method="post" action="#" id="operationForm">

				    <table class="other">
    					<tbody>
                        <tr class="fejlec">
    						<td class="uid"><a href="#" class="sort ASC" rel="megrendelo|cid|ASC">OID</a></td>
    						<td><a href="#" class="sort " rel="megrendelo|name|">Művelet</a></td>
    						<td><a href="#" class="sort " rel="megrendelo|address|">Típus</a></td>
    						<td><a href="#" class="sort " rel="megrendelo|phone|">Személyi ktg.</a></td>
