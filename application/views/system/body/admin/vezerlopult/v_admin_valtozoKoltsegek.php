		...
		<div id="content" class="brr">
            ...
            <div id="contentLeft">
                <div id="menuLeft">
					<ul>
                       ...
                       <li class="active"><?php echo anchor('vezerloPult/valtozoKoltsegek','Változó költségek<span>Itt lehet a változó költségeket felvenni és módosítani.</span>');?></li>
            ...
            <div id="contentRight">
                ...
                <div class="rightBlock">
                    ...
                    <div id="valtozoKoltsegListazAjax" class="ajaxContainer">
        		      <div class="rightBlock">
        			     <div class="title">
        				    Változó költségek
        				    <div class="controls">
			          ...
			          <div class="content cont-close">
                        ...
                        <div class="ajax_loader"></div>
				            <form method="post" action="#" id="variableCostsForm">
                                <table class="other">
					               <tbody>
                                      <tr class="fejlec">
						              <td class="uid"><a href="#" class="sort ASC" rel="hozzaferes|uid|ASC">VID</a></td>
    						              <td><a href="#" class="sort " rel="hozzaferes|username|">Név</a></td>
    						              <td><a href="#" class="sort " rel="hozzaferes|fullname|">Költség</a></td>
    						              <td><a href="#" class="sort " rel="hozzaferes|enabled|">Költség/nap</a></td>
    						              <td><a href="#" class="sort " rel="hozzaferes|class|">Költség/óra</a></td>
