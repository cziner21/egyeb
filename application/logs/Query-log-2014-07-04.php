...
SELECT *
FROM (`dolgozok`)
WHERE LOWER(username)= 'dolg_01aa'
OR LOWER(email)= 'dolg_01aa' 
 Execution Time:0.00099992752075195
...
INSERT INTO `login_attempts` (`ip_address`, `login`) VALUES ('::1', 'dolg_01AA') 
 Execution Time:0.00099992752075195
...
SELECT *
FROM (`dolgozok`)
WHERE LOWER(username)= 'kiss@k.hu'
OR LOWER(email)= 'kiss@k.hu' 
 Execution Time:0.00099992752075195
...
INSERT INTO `login_attempts` (`ip_address`, `login`) VALUES ('::1', 'kiss@k.hu') 
 Execution Time:0.00099992752075195
